    ...
    <footer className="bg-stone-900 text-stone-300 pt-16 pb-8 border-t border-stone-800">
      ...
      <div className="max-w-7xl mx-auto px-4 pb-12 mb-12 border-b border-stone-800 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div className="flex items-start gap-4">
          <div className="w-12 h-12 rounded-xl bg-red-950/60 border border-red-700/40 flex items-center justify-center text-red-400 shrink-0">
            <Truck size={24} />
          </div>
          <div>
      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
        ...
        <div className="lg:col-span-2 space-y-4">
          <Link to="/" className="flex items-center gap-2">
            <div className="w-15 h-15 rounded-lg bg-white flex items-center justify-center text-white font-bold shadow-sm">
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-xs">
            <li><Link to="/products?category=phong-khach" className="hover:text-red-400 transition-colors">Sofa Da Bò Ý</Link></li>
            <li><Link to="/products?category=phong-khach" className="hover:text-red-400 transition-colors">Bàn Trà Mặt Đá Marble</Link></li>
            <li><Link to="/products?category=phong-ngu" className="hover:text-red-400 transition-colors">Giường Ngủ Gỗ Sồi</Link></li>
            <li><Link to="/products?category=phong-an" className="hover:text-red-400 transition-colors">Bàn Ăn Gỗ Óc Chó</Link></li>
            <li><Link to="/products?category=phong-lam-viec" className="hover:text-red-400 transition-colors">Bàn Làm Việc Thông Minh</Link></li>
            <li><Link to="/products?category=den-trang-tri" className="hover:text-red-400 transition-colors">Đèn Chùm Pha Lê</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-xs">
            <li><Link to="/orders" className="hover:text-red-400 transition-colors">Tra cứu đơn hàng</Link></li>
            <li><a href="#" className="hover:text-red-400 transition-colors">Chính sách bảo hành 5 năm</a></li>
            <li><a href="#" className="hover:text-red-400 transition-colors">Chính sách vận chuyển & lắp đặt</a></li>
            <li><a href="#" className="hover:text-red-400 transition-colors">Hướng dẫn thanh toán QR Bank</a></li>
            <li><a href="#" className="hover:text-red-400 transition-colors">Quy trình đổi trả sản phẩm</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <Button type="primary" className="!bg-red-700 hover:!bg-red-600 font-bold text-xs">
              Đăng Ký Ngay
            </Button>
          </div>
        </div>
